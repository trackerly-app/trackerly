  ...
  return (
    <div className='inline-flex flex-row items-stretch w-full pr-5'>
      <div className='flex flex-col items-stretch w-full pr-5 pt-5'>
        ...
        <button
          type='button'
          className='text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 mt-5'
